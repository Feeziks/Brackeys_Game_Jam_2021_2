...
[CreateAssetMenu(menuName = "Scriptable Objects/Abilities/Tornado")]
public class SO_Tornado_Ability_Action : SO_ScriptableAction
{
  ...
  public override void PerformAction(GameObject abilityManager, SO_Ability callingAbility)
  {
    ...
    abilityManager.SendMessage("Tornado", temp);
  }
}
